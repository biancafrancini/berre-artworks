...
export const Navbar = ({contacts : contacts} : { contacts: React.RefObject<HTMLDivElement | null> }) => {
  return (
    <div className="navbar fixed top-0 flex md:justify-start justify-center w-full hover:shadow-xl">
      <div className="flex flex-row justify-between md:text-xl text-lg md:m-4 m-8 gap-4">
        <Link href="/">
